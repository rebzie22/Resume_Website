...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'jordanguck22@gmail.com',
      href: 'mailto:jordanguck22@gmail.com'
    },
    // Phone number section hidden for privacy
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/jguck1337',
      icon: (
          ...
          <div className="space-y-8">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="p-3 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-all hover:scale-110 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400"
            ...
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white">
              ...
              <p className="text-blue-100 mb-4">
                I'm always interested in hearing about new projects and opportunities. Whether you're a company looking for a developer or a fellow developer wanting to collaborate, I'd love to hear from you.
              </p>
              <div className="flex flex-wrap gap-2">
                ...
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm">C#</span>
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm">.NET</span>
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm">SQL Server</span>
